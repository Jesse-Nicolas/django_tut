...
def create_question(text, days):
    # create a question with the given 'text' and published the given number of 'days' offset to now (negative for questions published in the past, positive for questions that have yet to be published)
...
class QuestionResultsViewTests(TestCase):
    def test_future_questions(self):
        # results view of a question with a 'pub_date' in the future returns a 404 not found.        
        future_question = create_question(text='Future question', days=1)
